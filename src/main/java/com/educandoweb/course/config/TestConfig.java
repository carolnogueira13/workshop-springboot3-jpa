...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception { // tudo dentro desse metodo será iniciado quando o programa rodar
		...
		p1.getCategory().add(cat2); // a partir desse momento dentro do p1 está adiconado o cat2
		...
		ProductRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5)); // Salvar novamente, agora essas associações que foram relizadas
